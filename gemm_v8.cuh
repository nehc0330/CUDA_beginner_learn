    ...
    float *__restrict__ d_C)
{
    ...
    // for (int i = 0; i < fetch_float; ++i)//303.55
    // {
    //     A_block[write][A_tile_tx * 4 + i][A_tile_ty] = a_tmp[i];
    // }
